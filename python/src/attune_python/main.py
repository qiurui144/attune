...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    """应用生命周期管理"""
    _setup_logging()
    logger.info("Starting attune-python v0.1.0")
    ...
    logger.info(
        "attune-python ready: %d items, %d vectors, %d pending embeddings",
    ...
    # 清理
    logger.info("Shutting down attune-python")
    if state.watcher:
        state.watcher.stop()
...
# 注册路由
from attune_python.api.ingest import router as ingest_router
from attune_python.api.search import router as search_router
from attune_python.api.items import router as items_router
from attune_python.api.index import router as index_router
from attune_python.api.status import router as status_router
from attune_python.api.settings import router as settings_router
from attune_python.api.model_routes import router as models_router
from attune_python.api.skills import router as skills_router
from attune_python.api.ws import router as ws_router
from attune_python.api.setup import router as setup_router
