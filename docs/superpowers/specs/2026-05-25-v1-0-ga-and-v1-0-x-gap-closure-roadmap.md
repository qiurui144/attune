...
| ⚠️ **5/26 hotfix** | **Legal P0 + Release Eng P1**(audit 拉出) | (a) ToS / Privacy Policy publish 到 attune.ai(SaaS 通用模板 + 律师 P3 审) (b) ICP 备案状态确认 / 决策(备案 vs 海外服务器) (c) winget / apt / rpm 干净环境真验证 | **2026-05-26** before 上架 | main | v1.0.0 |
