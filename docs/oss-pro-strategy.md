...
> attune-pro = 个人用户的行业增强；attune-enterprise = 律所小团队 B2B 方案。* v0.6.0-rc.2
...
> attune (OSS) × attune-pro × attune-enterprise = **三角矩阵**
...
1. **是否专属律所 B2B 团队场景**（多租户 / RBAC / 案件分配 / 多人协作）？→ **attune-enterprise**（独立产品）
