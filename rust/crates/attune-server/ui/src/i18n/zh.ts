...
export const zh = {
  ...
  'wizard.pwd.heading': '设置 Vault 主密码（本地）',
  'wizard.pwd.warning': '⚠ 这是本地 Vault 主密码；会员用户名/密码请在下一步填写。数据本地 Argon2id + AES-256-GCM 加密。',
  'wizard.pwd.field': 'Vault 主密码',
  ...
  'wizard.pwd.unlocked_hint': 'Vault 已解锁：可直接下一步；如需再次校验，也可输入主密码。',
  'wizard.pwd.locked_hint': 'Vault 已设置：请输入现有主密码解锁后继续。',
  ...
  'wizard.member.desc': 'Vault 主密码只保护本地数据；会员账号密码用于云端同步与授权码校验。',
  ...
  'settings.ai.llm.title': 'LLM 后端',
  'settings.ai.llm.preset': '快捷预设',
  'settings.ai.llm.endpoint': 'Endpoint',
  'settings.ai.llm.model': 'Chat 模型',
  'settings.ai.llm.api_key': 'API Key',
  'settings.ai.llm.api_key_keep': '已配置（留空保留）',
  'settings.ai.llm.api_key_placeholder': '粘贴 sk-... ',
  'settings.ai.llm.saving': '保存中…',
  'settings.ai.llm.save': '💾 保存 LLM 配置',
  'settings.ai.llm.saved_toast': '已保存 LLM 配置',
