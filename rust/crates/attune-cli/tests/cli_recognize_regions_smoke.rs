...
fn tiny_png() -> tempfile::NamedTempFile {
    ...
    const PNG: &[u8] = &[
        ...
        0x54, 0x78, 0x9C, 0x63, 0xFC, 0xFF, 0xFF, 0x3F, 0x03, 0x35, 0x80, 0x91, 0x81, 0x81, 0x91,
        0x11, 0x00, 0x36, 0xF0, 0x05, 0xFE, 0x6E, 0x9F, 0x9A, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x49,
        0x45, 0x4E, // IEND
...
fn recognize_regions_no_models_degrades_to_empty_envelope() {
    ...
    attune_cmd()
        ...
        .stdout(predicate::str::contains(
            r#""capability": "visual-understanding""#,
        ))
